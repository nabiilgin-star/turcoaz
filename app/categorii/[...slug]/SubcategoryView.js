                ...
                >
                  ...
                  <div style={{ padding: "20px", display: "flex", flexDirection: "column", flexGrow: 1, justifyContent: "space-between" }}>
                    <div style={{ minHeight: "44px", display: "flex", alignItems: "center", marginBottom: "16px" }}>
                      <span style={{ fontSize: "15px", fontWeight: "700", color: "#0F172A", lineHeight: "1.4", width: "100%" }}>
                        {sub.name}
                      </span>
                    </div>
                    ...
                    <div style={{ textAlign: "center", marginTop: "auto" }}>
                      <span style={{
                        ...
                        boxShadow: "0 2px 6px rgba(197, 164, 145, 0.3)"
                      }}>
                        VEZI DETALII
                      </span>
                    </div>
              ...
              {products.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ padding: "20px", display: "flex", flexDirection: "column", flexGrow: 1, justifyContent: "space-between" }}>
                      <div style={{ minHeight: "44px", display: "flex", alignItems: "center", marginBottom: "16px" }}>
                        <h3 style={{ fontSize: "15px", fontWeight: "700", color: "#0F172A", margin: 0, lineHeight: "1.4", width: "100%" }}>
