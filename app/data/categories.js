...
export const categories = [
  ...
  },
 {
   ...
   description: "Panouri Compozit (Bond) pentru Fațade – Calitate Superioară și Avantaje Majore\nCăutați plăci compozit de înaltă calitate în România? Oferim soluții moderne pentru fațade arhitecturale ventilate, placări exterioare și interioare, cu stoc permanent disponibil în depozit.\n\n### 🏆 De ce să alegi panourile noastre compozit (Bond)?\n* **Agrement Tehnic în România:** Produsele noastre dețin toate certificările și agrementul tehnic necesar pentru proiecte civile și industriale conforme cu standardele din România.\n* **Calitate Norvegienă (Prime Bond):** Aluminiu de primă clasă importat din Norvegia, asigurând o durabilitate extremă, rezistență la intemperii și finisaje impecabile (PVDF/HDP).\n* **Preț Avantajos și Competitiv:** Oferim prețuri net superioare și mai avantaje față de competitori direcți precum Geplast sau alte alternative de pe piață, fără a fazer rabat la calitate.\n* **Stoc Disponibil & Livrare Rapidă:** Asigurăm stocuri consistente în depozit pentru livrări imediate în toată țara, evitând timpii de așteptare din șantiere."
    gallery: [
