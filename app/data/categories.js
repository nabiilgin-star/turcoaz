...
export const categories = [
  ...
  },
 {
   ...
   description: "Panouri Compozit (Bond) pentru Fațade – Calitate Superioară și Avantaje Majore.<br>Căutați plăci compozit de înaltă calitate în România? Oferim soluții moderne pentru fațade arhitecturale ventilate, placări exterioare și interioare, cu stoc permanent disponibil în depozit.<br><br>🏆 <strong>De ce să alegi panourile noastre compozit (Bond)?</strong><br>• <strong>Agrement Tehnic în România:</strong> Produsele noastre dețin toate certificările și agrementul tehnic necesar pentru proiecte civile și industriale conforme cu standardele din România.<br>• <strong>Calitate Norvegienă (Prime Bond):</strong> Aluminiu de primă clasă importat din Norvegia, asigurând o durabilitate extremă, rezistență la intemperii și finisaje impecabile (PVDF/HDP).<br>• <strong>Preț Avantajos și Competitiv:</strong> Oferim prețuri net superioare și mai avantajoase față de competitori direcți precum Geplast sau alte alternative de pe piață, fără a face rabat la calitate.<br>• <strong>Stoc Disponibil & Livrare Rapidă:</strong> Asigurăm stocuri consistente în depozit pentru livrări imediate în toată țara, evitând timpii de așteptare din șantiere.",
   gallery: [
