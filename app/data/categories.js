...
export const categories = [
  ...
  },
 {
   ...
   description: "Panouri Compozit (Bond) pentru Fațade – Calitate Superioară și Avantaje Majore.<br>Căutați plăci compozit de înaltă calitate în România? Oferim soluții moderne pentru fațade arhitecturale ventilate, placări exterioare și interioare, cu stoc permanent disponibil în depozit.<br><br>🏆 <strong style='font-size: 1.1rem; color: #1f2937;'>Avantaje Majore</strong><br><br>• <strong style='color: #111827; text-decoration: none;'>Agrement Tehnic în România</strong> — produse certificate pentru proiecte civile și industriale, conforme cu standardele naționale.<br><br>• <strong style='color: #111827; text-decoration: none;'>Primebond – Aluminiu Hydro Norvegia</strong> — panourile sunt fabricate cu aluminiu premium de la Hydro Norvegia, oferind <strong>durabilitate maximă</strong>, <strong>stabilitate structurală</strong> și <strong>finisaje PVDF/HDP de top</strong>, standardul de referință în fațade moderne.<br><br>• <strong style='color: #111827; text-decoration: none;'>Preț Competitiv</strong> — costuri avantajoase față de Geplast și alte alternative, menținând calitatea superioară.<br><br>• <strong style='color: #111827; text-decoration: none;'>Stoc & Livrare Rapidă</strong> — disponibilitate imediată și distribuție eficientă în toată țara.",
   gallery: [
