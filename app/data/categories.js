  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
       ...
       description: "Sisteme Premium de Glafuri din Aluminiu Extrudat | Pervazuri Profesionale pentru Ferestre.<br>Căutați glafuri din aluminiu, pervazuri din aluminiu de înaltă calitate, pervaz aluminiu sau glaf aluminiu pentru ferestre în România? S.C. Turcoaz Aluminiu S.R.L. oferă soluții durabile și estetice pentru tâmplărie PVC și aluminiu, cu stoc permanent în depozitul din Popești-Leordeni.<br><br>🏆 <strong style='font-size: 1rem; color: #1f2937;'>Caracteristici Tehnice & Avantaje Majore</strong><br><br>• <strong style='font-size: 0.9rem; color: #111827; text-decoration: none;'>Personalizare Cromatică RAL</strong> <span style='font-size: 0.85rem; color: #4b5563;'>— se poate vopsi electrostatic în orice culoare RAL dorită pentru o armonie perfectă cu designul fațadei.</span><br><br>• <strong style='font-size: 0.9rem; color: #111827; text-decoration: none;'>Dimensiuni & Grosime Robuste</strong> <span style='font-size: 0.85rem; color: #4b5563;'>— opțiuni variate de lățime a profilului între 75 mm și 380 mm, cu o grosime a peretelui cuprinsă între 1,4 mm și 2,5 mm pentru rezistență structurală superioară.</span><br><br>• <strong style='font-size: 0.9rem; color: #111827; text-decoration: none;'>Lungimi Extinse</strong> <span style='font-size: 0.85rem; color: #4b5563;'>— bare cu lungimi cuprinse între 4000 mm și 7000 mm, ideale pentru proiecte rezidențiale și industriale de amploare.</span><br><br>• <strong style='font-size: 0.9rem; color: #111827; text-decoration: none;'>Protecție Împotriva Infiltrațiilor</strong> <span style='font-size: 0.85rem; color: #4b5563;'>— direcționează eficient scurgerea apei spre exterior datorită înclinării optime, prevenind infiltrațiile în perete, pierderile termice și formarea condensului.</span>",
        gallery: [
